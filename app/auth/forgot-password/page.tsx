            ...
            <div className="auth-card fade-in">
                ...
                {success ? (
                    <div className="text-center">
                        ...
                        <Link href="/auth/login" className="glass-button" style={{ display: 'block', width: '100%', textAlign: 'center', padding: 'var(--spacing-md)' }}>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-md">
                        ...
                        <div className="text-center mt-md" style={{ paddingTop: 'var(--spacing-md)', borderTop: '1px solid var(--color-glass-border)' }}>
                            <Link href="/auth/login" className="glass-button" style={{ display: 'block', width: '100%', textAlign: 'center', padding: 'var(--spacing-md)' }}>
                                Retour a la connexion
                            </Link>
                        </div>
